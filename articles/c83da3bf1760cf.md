---
title: "BOHB 論文解説：候補生成と予算配分から理解する Multi-fidelity HPO"
emoji: "📚"
...
多数のハイパーパラメータ設定を validation set 上で比較すると、偶然良く評価された設定を選択してしまう可能性がある。このような HPO による validation set への過適合は [**overtuning**](https://arxiv.org/abs/2506.19540) と呼ばれる。
